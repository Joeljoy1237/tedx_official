...
export default function ScrollTextView() {
  return (
    <div className="relative flex overflow-x-hidden">
      <div className="py-[12vh] animate-marquee whitespace-nowrap gap-8 flex items-center justify-center">
      ...
      <div className="absolute top-0 py-[12vh] animate-marquee2 whitespace-nowrap flex gap-8">
        <span className="text-6xl font-bold ml-6 text-primary-700">
          {" "}
          TED<sup className="top-[-16px]">x</sup> CCET
        </span>
